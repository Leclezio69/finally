...
```bash
INIT=$(node "/Users/richardleclezio/projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/richardleclezio/projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
