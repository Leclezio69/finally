...
```bash
INIT=$(node "/Users/richardleclezio/projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/richardleclezio/projects/finally/.claude/get-shit-done/templates/spec.md.
