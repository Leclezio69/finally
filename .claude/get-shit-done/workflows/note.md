...
- **Global scope**: `/Users/richardleclezio/projects/finally/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/richardleclezio/projects/finally/.claude/notes/`)
...
2. Glob `/Users/richardleclezio/projects/finally/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/richardleclezio/projects/finally/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/richardleclezio/projects/finally/.claude/notes/` — works in any directory
