...
INSTALL_JS_GLOBAL="/Users/richardleclezio/projects/finally/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/richardleclezio/projects/finally/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
