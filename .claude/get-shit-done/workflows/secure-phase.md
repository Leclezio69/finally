...
```
Agent(
  prompt="Read /Users/richardleclezio/projects/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/richardleclezio/projects/finally/.claude/get-shit-done/templates/SECURITY.md`
